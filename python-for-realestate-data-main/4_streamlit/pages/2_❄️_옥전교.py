...
st.header('저온구간 두번째 - 옥전교', divider='rainbow')
...
with col1:
    option = st.selectbox('표시 이미지 선택:',
                 ['저온구간2(남해고속도로 교차점 - 옥전교) 위성사진',
                  '저온구간2(남해고속도로 교차점 - 옥전교) 도로교차지점 거리뷰',
                  '지도 시각화(1차 관측)',
                  '지도 시각화(2차 관측)',
                  '지도 시각화(3차 관측)',
                  '지도 시각화(4차 관측)'
...
with col2:
    if option == '저온구간2(남해고속도로 교차점 - 옥전교) 위성사진':
        st.image(image_url2)  # 해당 이미지 파일의 경로
    elif option == '저온구간2(남해고속도로 교차점 - 옥전교) 도로교차지점 거리뷰':
        st.image(image_url3)
...
st.subheader('저온구간2(남해고속도로 고각하부-옥전교) 1~4차 관측회차 별 시계열 그래프 및 박스그림                                                                               ')
col1, col2 = st.columns([1,1])
